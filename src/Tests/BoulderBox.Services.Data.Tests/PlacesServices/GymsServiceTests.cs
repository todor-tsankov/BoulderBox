...
namespace BoulderBox.Services.Data.Tests.PlacesServices
{
    public class GymsServiceTests
    {
        ...
        [Theory]
        [InlineData("gymName1", "description1", "cityId1", false, "/img/imageId1.jpeg")]
        [InlineData("gymName2", "",             "cityId2", false, "/img/imageId2.jpeg")]
        [InlineData("gymName3", null,           "cityId3", false, "/img/imageId3.jpeg")]
        [InlineData("gymName4", "description4", "cityId4", true, null)]
        [InlineData("gymName5", "",             "cityId5", true, null)]
        [InlineData("gymName6", null,           "cityId6", true, null)]
        ...
        [Theory]
        [InlineData("name1", "desc1", "cityId1", "newName1", "newDesc1", "newCityId1", false, "imageSerc1", "newImageSrc1")]
        [InlineData("name2", "",      "cityId2", "newName2", "newDesc2", "newCityId2", false, "imageSerc2", "newImageSrc1")]
        [InlineData("name3", null,    "cityId3", "newName3", "newDesc3", "newCityId3", false, "imageSerc3", "newImageSrc1")]
        [InlineData("name4", "desc4", "cityId4", "newName4", "newDesc4", "newCityId4", false, null, null)]
        [InlineData("name5", "",      "cityId5", "newName5", "newDesc5", "newCityId5", false, null, null)]
        [InlineData("name6", null,    "cityId6", "newName6", "newDesc6", "newCityId6", false, null, null)]
